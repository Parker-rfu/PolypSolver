...
if __name__ == '__main__':
    method_name = 'PolypSolver'
    parser = argparse.ArgumentParser()
    parser.add_argument('--testsize', type=int, default=352, help='testing size')
    parser.add_argument('--pth_path', type=str, default='best.pth')  #your best train_pth
    ...
    for _data_name in ['CVC-300', 'CVC-ClinicDB', 'Kvasir', 'CVC-ColonDB', 'ETIS-LaribPolypDB']:
        ...
        ##### save_path #####
        save_path = './result no add/'+method_name+'/{}/'.format(_data_name)
        ...
        for i in range(num1):
            ...
            # eval Dice
            res = F.upsample(res1 + res2, size=gt.shape, mode='bilinear', align_corners=False)
